  ...
  return (
    ...
    >
      <div className="container px-4 py-12 md:py-16">
        {scene.wide ? (
          // Wide (teacher) layout: steps on top, big desktop shots stacked below.
          ...
          // Phone-first zigzag: portrait screenshot beside the steps.
          <div
          ...
          >
            ...
            <div className="w-full md:w-1/2">{body}</div>
          </div>
        )}
      </div>
    </section>
